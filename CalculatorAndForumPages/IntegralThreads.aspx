<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IntegralThreads.aspx.cs" Inherits="Forum"  validateRequest="false"%>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="subjectLbl" runat="server" Text="Antiderivatives" Font-Bold="True" Font-Size="32px"></asp:Label>
        ...
        <asp:Button Visible="false" ID="viewButton" style="margin-top:150px; width:45%" runat="server" Text="View" UseSubmitBehavior="false"></asp:Button>
        <asp:Button Visible="false" ID="deleteButton" style="margin-top:150px; width:45%" runat="server" Text="Delete" UseSubmitBehavior="false"></asp:Button>

        <asp:PlaceHolder runat="server" ID="forumsPlaceholder" />
        <br />

        <asp:Label ID="CreateYourOwnPostLbl" runat="server" Font-Size="32px">Create Your Own Post:</asp:Label>
        <br />
        <asp:Label ID="newTitleLbl" runat="server">Title:</asp:Label>
        <br />
        <asp:TextBox ID="forumTitleTxt" runat="server" Width="100%" ></asp:TextBox>
        <br />
        <asp:Label ID="messageLbl" runat="server">Post:</asp:Label>
        <br />
        <asp:TextBox ID="forumPostTxt" runat="server" Height="200px" Width="100%"  TextMode="MultiLine"></asp:TextBox>
        <br />
