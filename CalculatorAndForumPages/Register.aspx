...
<body>
    ...
    <div style="height: 531px">
        ...
        <div style="margin-left: auto; margin-right: auto; text-align: center;">
            <asp:Label ID="registerLbl" runat="server" Text="Register" Font-Bold="true" Font-Size="X-Large" CssClass="StrongText"></asp:Label>
            ...
            <asp:Button ID="registerButton" runat="server" Text="Register" OnClick="Register_Button_Click"/>
            ...
            <asp:Label ID="usernameExistsLbl" runat="server" Text="The username is taken." Font-Bold="true" Font-Size="X-Large" CssClass="StrongText" ForeColor="Red" Visible="false"></asp:Label>
