...
public partial class IntegralReply : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Reply"] == null)
            Response.Redirect("IntegralThreads.aspx");
    ...
    * */
    ...
    protected void postButton_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "INSERT INTO posts (forum_board, post_message, is_start_of_thread, user_id) VALUES (2, @message, " + Session["Reply"] + ", " + Session["userID"] + ")";
