...
public partial class Forum : System.Web.UI.Page
{
    ...
    * */
    public void ListThreads()
    {
        ...
        cmd.CommandText = "SELECT COUNT(*) FROM posts WHERE forum_board = 2 AND is_start_of_thread = 0";
        ...
        for (int i = 0; i < postCount; i++)
        {
            while (!rowFound)
            {
                ...
                cmd.CommandText = "SELECT COUNT(*) FROM posts WHERE post_id = " + idTracker + " AND forum_board = 2 AND is_start_of_thread = 0";
    ...
    public void View_Post_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("IntegralReply.aspx", true);
    }
    ...
    protected void postButton_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "INSERT INTO posts (forum_board, post_title, post_message, is_start_of_thread, user_id) VALUES (2, @title, @message, " + 0 +
            ", " + Session["userID"] + ")";
    ...
    protected void Delete_Post_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = cmd.CommandText = "DELETE FROM posts WHERE forum_board = 2 AND is_start_of_thread = " + button.ID.ToString().Substring(3);
