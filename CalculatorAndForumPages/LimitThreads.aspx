<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LimitThreads.aspx.cs" Inherits="Forum" validateRequest="false" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="subjectLbl" runat="server" Text="Limits" Font-Bold="True" Font-Size="32px"></asp:Label>
